...
from videoxlpro.constants import IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN
...
def process_video(video_path,tokenizer,image_processor, model_device, max_frames=128,gen_kwargs=None, use_sae=True):
    """
    处理视频并返回处理后的张量
